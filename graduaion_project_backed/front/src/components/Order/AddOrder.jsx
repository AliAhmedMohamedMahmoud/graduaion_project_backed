        ...
        <Table striped bordered hover>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <input name="Quantity" onChange={whenQuantityChange}></input>
              </td>
              <td>
                <input name="Weigth" onChange={whenWeigthChange}></input>
              </td>
            </tr>
          </tbody>
        </Table>
        <button onClick={whenClick} className="btn btn-primary">
          Add Product
        </button>
        <Table striped bordered hover>
          <thead>
