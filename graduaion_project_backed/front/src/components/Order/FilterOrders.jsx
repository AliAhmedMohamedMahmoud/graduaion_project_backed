...
export default function ShowOrderss() {
    ...
    const [StatusDate,setStatusDate]=useState({Statusid:"",StartDate:"",EndDate:"",PageId:1})
    const handleInput = (e) => {
        setStatusDate({
            ...StatusDate,
            [e.target.name]: (
    ...
    let sendDateAndStatus=()=>{
        getByStatusAndDate(StatusDate).then((Data) => {
            ...
            <div class="container">
                <div class="table-responsive">
                    <div class="table-wrapper">
                        ...
                        <select value={Status.statusId} name='Statusid' onChange={handleInput} class="form-select mt-3" aria-label="Default select example">
                        ...
                        <table class="table table-striped table-hover table-bOrdersed">
                            <thead>
                                <tr>
                                    ...
                                    <th>Coset <i class="fa fa-sort"></i></th>
                                    <th>Customer Name <i class="fa fa-sort"></i></th>
                                    <th>CustomerPhone <i class="fa fa-sort"></i></th>
                                    <th>City Name <i class="fa fa-sort"></i></th>
                                    <th>stateName <i class="fa fa-sort"></i></th>
                                    

                                </tr>
                            </thead>
                            <tbody>
                            {Order.map(({id,date,cost,customerName,customerPhone,cityName,stateName}) => {
                                    return (<tr>
                                            <td>{id}</td>
                                            <td>{date}</td>
                                            <td>{cost}</td>
